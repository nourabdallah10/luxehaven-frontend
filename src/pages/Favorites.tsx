...
import { getAllProducts, getProductImagePath } from '../data/products';
      ...
      <div className="favorites">
        <div className="container">
          <div className="favorites__empty">
            ...
            <h1 className="favorites__empty-title">{t('favorites.empty.title')}</h1>
            <p className="favorites__empty-text">
              {t('favorites.empty.message')}
            </p>
            <Link to="/" className="btn favorites__empty-button">
    ...
    <div className="favorites">
      <div className="container">
        ...
        <div className="favorites__header">
          ...
          <button 
            className="btn btn--secondary favorites__remove-all"
        ...
        {/* Customizable Notice */}
        <div className="customizable-notice">
          <div className="customizable-notice__content">
            ...
            <p className="customizable-notice__text">{t('favorites.customizable')}</p>
            <a 
        ...
        <div className="favorites__grid">
          {favoriteProducts.map((product) => {
            ...
            return (
              ...
              >
                <div className="favorites-product-card__image-wrapper">
                  <img
                    src={primaryImage}
                  ...
                  />
                  <button
                    className="favorites-product-card__favorite favorites-product-card__favorite--active"
                ...
                <div className="favorites-product-card__info">
                  <h3 className="favorites-product-card__name">{formatProductName(product.name)}</h3>
                </div>
              </Link>
            );
          })}
